...
interface AddChartModalProps {
  ...
  coins: ScannedCoin[];
  watchlist: string[];
  onAddChart: (coin: ScannedCoin, timeframe: Timeframe, mode: 'tradingview' | 'pattern', formationId?: string) => void;
}
...
export const AddChartModal: React.FC<AddChartModalProps> = ({
  ...
  const [selectedMode, setSelectedMode] = useState<'tradingview' | 'pattern'>('tradingview');
  ...
  const filteredCoins = useMemo(() => {
    ...
    return result;
  }, [coins, filterTab, selectedExchange, watchlist, search]);
        ...
        <div className="p-3 sm:p-4 border-b border-slate-800/80 bg-slate-950/40 space-y-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="Пошук монети (наприклад: BTC, ETH, SOL, SUI)..."
              autoFocus
          ...
          <div className="flex flex-wrap items-center justify-between gap-2 text-xs">
            <div className="flex flex-wrap items-center gap-1">
              ...
              >
                ...
                <span>Обрані ({watchlist.length})</span>
              </button>
              <button
          ...
          {/* Timeframe & Chart Type selection */}

        ...
        <div className="flex items-center flex-wrap gap-2 ml-auto">
          ...
          <div className="flex items-center bg-slate-950 px-2 py-1 rounded-lg border border-slate-800 text-[11px] text-slate-300">
            ...
            >
              ...
              <option value={50000} className="bg-slate-900">До $50K</option>
              <option value={100000} className="bg-slate-900">До $100K</option>
              <option value={500000} className="bg-slate-900">До $500K</option>
              <option value={1000000} className="bg-slate-900">До $1M</option>
              <option value={5000000} className="bg-slate-900">До $5M</option>
              <option value={20000000} className="bg-slate-900">До $20M</option>
              <option value={50000000} className="bg-slate-900">До $50M</option>
              <option value={100000000} className="bg-slate-900">До $100M</option>
              <option value={500000000} className="bg-slate-900">До $500M</option>
              <option value={1000000000} className="bg-slate-900">До $1B</option>
            </select>
          </div>

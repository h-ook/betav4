...
export const FormationDetailsModal: React.FC<FormationDetailsModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-0 sm:p-4 md:p-6 bg-black/80 backdrop-blur-sm overflow-y-auto">
            ...
            <div className="lg:col-span-2 space-y-3">
              <div className="flex flex-wrap items-center justify-between gap-2">
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="text-xs text-slate-400 flex items-center gap-1.5 hidden xs:flex">
                    <span>Обсяг 24г:</span>
                    <span className="font-mono font-semibold text-slate-200">
                      ${(coin.volume24hUsd / 1_000_000).toFixed(1)}M
                    </span>
                  </div>
              ...
              {loadingKlines ? (
                <div className="w-full h-[300px] xs:h-[350px] sm:h-[420px] md:h-[480px] lg:h-[540px] xl:h-[580px] 2xl:h-[640px] rounded-xl border border-slate-800 bg-slate-950 flex flex-col items-center justify-center text-slate-400 gap-2">

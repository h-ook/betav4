...
import { ExternalLink, TrendingUp, TrendingDown, Star, Target, ShieldAlert, BarChart2, Zap, Send, Bookmark } from 'lucide-react';
...
export const FormationCard: React.FC<FormationCardProps> = ({
  ...
  return (
    <div className="bg-slate-900/80 border border-slate-800 hover:border-slate-700 transition-all rounded-2xl p-4 flex flex-col justify-between hover:shadow-xl hover:shadow-cyan-950/20 group">
      ...
      <div className="grid grid-cols-3 gap-1.5 sm:gap-2 mb-3 text-center text-xs">

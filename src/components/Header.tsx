...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="border-b border-slate-800/80 bg-slate-950/80 backdrop-blur-md sticky top-0 z-30">
      <div className="max-w-[1720px] mx-auto px-3 sm:px-6 lg:px-8 py-2 sm:py-2.5">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center p-1 rounded-xl bg-slate-900/90 border border-slate-800 text-xs shadow-inner">
              ...
              >
                ...
                <span>Скрінер</span>
                <span className="px-1.5 py-0.2 rounded-full text-[9px] bg-cyan-400 text-slate-950 font-bold uppercase tracking-wider font-mono">
                  Ринок
                </span>
              </button>
              ...
              >
                ...
                <span>Термінал</span>
                <span className="px-1.5 py-0.2 rounded-full text-[9px] bg-emerald-400 text-slate-950 font-bold uppercase tracking-wider font-mono">
                  PRO
                </span>
              </button>
            </div>
